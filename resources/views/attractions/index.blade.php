    ...
    <section id="services-list" class="services-list ">
     <div class="container-fluid" data-aos="fade-up">
       ...
       <div class="section-header">
         <h2 class="title">Manage Attractions</h2>
              ...
              <div class="col-12">
                <div class="card top-selling overflow-auto">
                  ...
                  <div class="card-body pb-0">
                    ...
                    <div>
                      <button type="button" class="btn btn-primary mb-3"><a href="./attractions/addattractions" style="text-decoration:none; color:white; margin-bottom:2%">ADD NEW ATTRACTION</a></button>
                  </div>
...
{{--                         <th scope="col">SupervisorID</th> --}}
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="./attractions/{{$attraction->ID}}/editattraction" class="btn btn-success">Edit</a></td>
  
                        <td>{!!Form::open(['action'=> ['App\Http\Controllers\AssetController@destroyattraction',$attraction->ID], 'method' =>'POST', 'class' =>'pull-right'])!!}
