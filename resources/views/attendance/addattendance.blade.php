            ...
            <div class="row">
              ...
              <div class="col-12">
                <div class="card top-selling overflow-auto">
                  ...
                  <div>
                    {!! Form::open(['action' => 'App\Http\Controllers\ActivityController@storeattendance', 'method' => 'POST' , 'enctype'=>'multipart/form-data']) !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        {{Form::number('Revenue', '', ['class'=> 'form-control'])}}
                      </div>
                    
                    <div class="form-group">
                      {{Form::label('TicketsSold', 'TicketsSold')}}
                      {{Form::number('TicketsSold', '', ['class'=> 'form-control'])}}
                    </div>                        
